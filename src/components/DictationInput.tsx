...
export const DictationInput = forwardRef<HTMLTextAreaElement, DictationInputProps>(
  ({ value, onChange, placeholder = "Dictate and format text here...", disabled }, ref) => {
    return (
      <div className="relative group">
        ...
        <div className="relative glass-panel-glow rounded-xl overflow-hidden">
          ...
          <div className="absolute bottom-4 right-4 z-20">
            <div className="p-2.5 rounded-lg bg-navy-700/60 border border-border/50 backdrop-blur-sm transition-all duration-300 hover:bg-navy-600/60 hover:border-primary/30 cursor-pointer group/mic">
              <Mic className="w-4 h-4 text-muted-foreground group-hover/mic:text-primary transition-colors" />
            </div>
          </div>
